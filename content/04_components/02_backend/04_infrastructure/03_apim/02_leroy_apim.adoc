...
:imgdir: /02_02_04_03_02_img/
:imagesoutdir: ./static/02_02_04_03_02_img/
...
====
> Основной посыл заключается в том, чтобы разные типы бизнес-процессов компании накладывались на соответствующие домены *APIM* системы.
====
****
