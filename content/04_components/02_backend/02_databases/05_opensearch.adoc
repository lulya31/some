...
:imgdir: /04_02_02_05_img/
:imagesoutdir: ./static/04_02_02_05_img/
...
[source, json]
----
include::static/04_02_02_05_img/opensearch_postman_collection.json[]
----
====
****
...
====
> Последняя версия *OpenSearch* доступна для скачивания link:https://opensearch.org/downloads.html[*здесь*, window=_blank].
====
