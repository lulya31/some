...
:imgdir: /04_01_05_04_img/
:imagesoutdir: ./static/04_01_05_04_img/
...
====
> Для ознакомления с полным списком сопоставлений, ознакомьтесь со link:https://jestjs.io/ru/docs/expect[справочной документацией, window=_blank].
====
...
====
> Если вы используете средство запуска тестов `[.red]#jasmine2#`, учтите, что он вызывает хуки `[.red]#after*#` в порядке, обратном объявлению. Чтобы получить идентичный результат, приведенный выше пример следует изменить следующим образом:
====
