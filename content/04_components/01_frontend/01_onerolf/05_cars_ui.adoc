...
:imgdir: /04_01_01_05_img/
:imagesoutdir: ./static/04_01_01_05_img/
...
====
====
> База охватывает все *АМ* с которыми происходит взаимодействие по любому из *БП РОЛЬФ*: *НА*, *АСП*, *F&I* и сервис
====
****
