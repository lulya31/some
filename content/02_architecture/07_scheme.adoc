...
.*Компонентая схема *Flora* (Отобразить/Скрыть)*
[%collapsible%close]
====
++++
<iframe src="https://app.diagrams.net/#G1VU9raY2FAviEGuuNUEk2RcPv8U6wUjMw" width="100%" height="1000"></iframe>
++++
====
